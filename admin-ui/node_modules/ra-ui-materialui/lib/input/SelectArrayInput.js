...
var SelectArrayInput = function (props) {
    ...
    var _d = (0, react_1.useState)(0), labelWidth = _d[0], setLabelWidth = _d[1];
    ...
    var _e = (0, ra_core_1.useChoices)({
        optionText: optionText,
        optionValue: optionValue,
        disableValue: disableValue,
        translateChoice: translateChoice,
    }), getChoiceText = _e.getChoiceText, getChoiceValue = _e.getChoiceValue, getDisableValue = _e.getDisableValue;
    var _f = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, onFocus: onFocus, parse: parse, resource: resource, source: source, validate: validate }, rest)), input = _f.input, isRequired = _f.isRequired, _g = _f.meta, error = _g.error, submitError = _g.submitError, touched = _g.touched;
    ...
    var _h = (0, useSupportCreateSuggestion_1.useSupportCreateSuggestion)({
        create: create,
    ...
    var renderMenuItem = (0, react_1.useCallback)(function (choice) {
        return choice ? (React.createElement(core_1.MenuItem, { key: getChoiceValue(choice), value: getChoiceValue(choice), disabled: getDisableValue(choice) }, !!createItem && (choice === null || choice === void 0 ? void 0 : choice.id) === createItem.id
            ? createItem.name
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(core_1.FormControl, __assign({ margin: margin, className: (0, classnames_1.default)(classes.root, className), error: touched && !!(error || submitError), variant: variant }, sanitizeRestProps(rest)),
            React.createElement(core_1.InputLabel, { ref: inputLabel, id: label + "-outlined-label", error: touched && !!(error || submitError) },
                React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired })),
            React.createElement(core_1.Select, __assign({ autoWidth: true, labelId: label + "-outlined-label", multiple: true, error: !!(touched && (error || submitError)), renderValue: function (selected) { return (React.createElement("div", { className: classes.chips }, selected
                    .map(function (item) {
                    ...
                    .map(function (item) { return (React.createElement(core_1.Chip, { key: getChoiceValue(item), label: renderMenuItemOption(item), className: classes.chip })); }))); }, "data-testid": "selectArray" }, input, { onChange: handleChangeWithCreateSupport, value: input.value || [], labelWidth: labelWidth }, options), finalChoices.map(renderMenuItem)),
            React.createElement(core_1.FormHelperText, { error: touched && !!(error || submitError) },
