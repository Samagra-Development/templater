...
var SimpleFormIterator = function (props) {
    ...
    var classes = (0, useSimpleFormIteratorStyles_1.useSimpleFormIteratorStyles)(props);
    ...
    return fields ? (React.createElement(SimpleFormIteratorContext_1.SimpleFormIteratorContext.Provider, { value: context },
        React.createElement("ul", { className: (0, classnames_1.default)(classes.root, className) },
            submitFailed && typeof error !== 'object' && error && (React.createElement(core_1.FormHelperText, { error: true },
