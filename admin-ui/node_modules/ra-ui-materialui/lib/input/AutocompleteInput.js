...
var AutocompleteInput = function (props) {
    ...
    (0, ra_core_1.warning)((0, react_1.isValidElement)(optionText) && !matchSuggestion, "If the optionText prop is a React element, you must also specify the matchSuggestion prop:\n<AutocompleteInput\n    matchSuggestion={(filterValue, suggestion) => true}\n/>\n        ");
    (0, ra_core_1.warning)(source === undefined, "If you're not wrapping the AutocompleteInput inside a ReferenceInput, you must provide the source prop");
    (0, ra_core_1.warning)(choices === undefined, "If you're not wrapping the AutocompleteInput inside a ReferenceInput, you must provide the choices prop");
    var classes = useStyles(props);
    var inputEl = (0, react_1.useRef)();
    var anchorEl = (0, react_1.useRef)();
    var translate = (0, ra_core_1.useTranslate)();
    var _j = (0, ra_core_1.useInput)(__assign({ format: format, id: idOverride, input: inputOverride, meta: metaOverride, onBlur: onBlur, onChange: onChange, onFocus: onFocus, parse: parse, resource: resource, source: source, validate: validate }, rest)), id = _j.id, input = _j.input, isRequired = _j.isRequired, _k = _j.meta, touched = _k.touched, error = _k.error, submitError = _k.submitError;
    ...
    var doesQueryMatchSuggestion = (0, react_1.useMemo)(function () {
        ...
        if (isFunction) {
            var hasOption_1 = choices.some(function (choice) {
                ...
                return (0, get_1.default)(choice, text) === filterValue;
            });
            var selectedItemText_1 = optionText(selectedItem);
            return hasOption_1 || selectedItemText_1 === filterValue;
        }
        var selectedItemText = (0, get_1.default)(selectedItem, optionText);
        var hasOption = choices.some(function (choice) {
            return (0, get_1.default)(choice, optionText) === filterValue;
        });
    ...
    var _m = (0, ra_core_1.useSuggestions)({
        ...
        if (!resettable) {
            ...
            if (clearAlwaysVisible) {
                ...
                return (react_1.default.createElement(core_1.InputAdornment, { position: "end" },
                    react_1.default.createElement(core_1.IconButton, { className: classes.clearButton, "aria-label": label_1, title: label_1, disableRipple: true, disabled: true },
            ...
            return (react_1.default.createElement(core_1.InputAdornment, { position: "end" },
                react_1.default.createElement(core_1.IconButton, { className: classes.clearButton, "aria-label": label_2, title: label_2, disableRipple: true, onClick: handleClickClearButton(openMenu), onMouseDown: handleMouseDownClearButton, disabled: disabled },
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(downshift_1.default, __assign({ inputValue: filterValue, onChange: handleChangeWithCreateSupport, selectedItem: selectedItem, itemToString: function (item) { return getChoiceValue(item); } }, rest), function (_a) {
            ...
            return (react_1.default.createElement("div", { className: classes.container },
                react_1.default.createElement(core_1.TextField, __assign({ id: id, name: input.name, InputProps: __assign({ inputRef: (0, ra_core_1.mergeRefs)([
                            storeInputRef,
                            inputRef,
                            ...
                            onChange(event);
                        }, onFocus: onFocus }, InputPropsWithoutEndAdornment), error: !!(touched && (error || submitError)), label: react_1.default.createElement(ra_core_1.FieldTitle, __assign({ label: label }, labelProps, { source: source, resource: resource, isRequired: typeof isRequiredOverride !==
                            'undefined'
                            ? isRequiredOverride
