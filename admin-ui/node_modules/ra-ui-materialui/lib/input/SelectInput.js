...
var SelectInput = function (props) {
    ...
    (0, ra_core_1.warning)(source === undefined, "If you're not wrapping the SelectInput inside a ReferenceInput, you must provide the source prop");
    (0, ra_core_1.warning)(choices === undefined, "If you're not wrapping the SelectInput inside a ReferenceInput, you must provide the choices prop");
    var _c = (0, ra_core_1.useChoices)({
        optionText: optionText,
        optionValue: optionValue,
        translateChoice: translateChoice,
    }), getChoiceText = _c.getChoiceText, getChoiceValue = _c.getChoiceValue;
    var _d = (0, ra_core_1.useInput)(__assign({ format: format, onBlur: onBlur, onChange: onChange, onFocus: onFocus, parse: parse, resource: resource, source: source, validate: validate }, rest)), id = _d.id, input = _d.input, isRequired = _d.isRequired, meta = _d.meta;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(ResettableTextField_1.default, __assign({ id: id }, input, { onChange: handleChangeWithCreateSupport, select: true, label: label !== '' &&
...
var useStyles = (0, styles_1.makeStyles)(function (theme) { return (__assign(__assign({}, ResettableTextField_1.resettableStyles), { input: {
