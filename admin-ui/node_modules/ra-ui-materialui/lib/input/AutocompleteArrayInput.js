...
var AutocompleteArrayInput = function (props) {
    ...
    (0, ra_core_1.warning)(source === undefined, "If you're not wrapping the AutocompleteArrayInput inside a ReferenceArrayInput, you must provide the source prop");
    (0, ra_core_1.warning)(choices === undefined, "If you're not wrapping the AutocompleteArrayInput inside a ReferenceArrayInput, you must provide the choices prop");
    var classes = useStyles(props);
    var inputEl = (0, react_1.useRef)();
    var anchorEl = (0, react_1.useRef)();
    var _k = (0, ra_core_1.useInput)(__assign({ format: format, id: idOverride, input: inputOverride, meta: metaOverride, onBlur: onBlur, onChange: onChange, onFocus: onFocus, parse: parse, resource: resource, source: source, validate: validate }, rest)), id = _k.id, input = _k.input, isRequired = _k.isRequired, _l = _k.meta, touched = _l.touched, error = _l.error, submitError = _l.submitError;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(downshift_1.default, __assign({ inputValue: filterValue, onChange: handleChangeWithCreateSupport, selectedItem: selectedItems, itemToString: function (item) { return getChoiceValue(item); } }, rest), function (_a) {
            ...
            return (react_1.default.createElement("div", { className: classes.container },
                react_1.default.createElement(core_1.TextField, __assign({ id: id, fullWidth: fullWidth, InputProps: __assign({ inputRef: (0, ra_core_1.mergeRefs)([
                            storeInputRef,
                            inputRef,
                        ]), classes: {
                            ...
                            input: classes.inputInput,
                                ...
                                _c)) }, selectedItems.map(function (item, index) { return (react_1.default.createElement(core_1.Chip, { key: index, tabIndex: -1, label: getChoiceText(item), className: classes.chip, onDelete: handleDelete(item) })); }))), endAdornment: loading && (react_1.default.createElement(AutocompleteInputLoader_1.AutocompleteInputLoader, null)), onBlur: onBlur, onChange: function (event) {
                            handleFilterChange(event);
                            onChange(event);
                        }, onFocus: onFocus }, InputPropsWithoutInputRef), error: !!(touched && (error || submitError)), label: react_1.default.createElement(ra_core_1.FieldTitle, __assign({ label: label }, labelProps, { source: source, resource: resource, isRequired: typeof isRequiredOverride !==
                            'undefined'
                            ? isRequiredOverride
