...
var Toolbar = function (props) {
    ...
    return (React.createElement(react_1.Fragment, null,
        React.createElement(Toolbar_1.default, __assign({ className: (0, classnames_1.default)(classes.toolbar, (_a = {},
...
Toolbar.propTypes = {
    ...
    width: prop_types_1.default.oneOf(['xs', 'sm', 'md', 'lg', 'xl']),
};
Toolbar.defaultProps = {
    submitOnEnter: true,
};
exports.default = (0, withWidth_1.default)({ initialWidth: 'xs' })(Toolbar);
