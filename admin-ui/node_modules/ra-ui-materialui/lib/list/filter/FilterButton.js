...
var FilterButton = function (props) {
    ...
    var _a = (0, ra_core_1.useListContext)(props), _b = _a.displayedFilters, displayedFilters = _b === void 0 ? {} : _b, filterValues = _a.filterValues, showFilter = _a.showFilter;
    ...
    if (hiddenFilters.length === 0)
        return null;
    return (React.createElement("div", __assign({ className: (0, classnames_1.default)(classes.root, className) }, sanitizeRestProps(rest)),
        React.createElement(Button_1.default, { className: "add-filter", label: "ra.action.add_filter", "aria-haspopup": "true", onClick: handleClickButton },
            React.createElement(FilterList_1.default, null)),
        React.createElement(Menu_1.default, { open: open, anchorEl: anchorEl.current, onClose: handleRequestClose }, hiddenFilters.map(function (filterElement, index) { return (React.createElement(FilterButtonMenuItem_1.FilterButtonMenuItem, { key: filterElement.props.source, filter: filterElement, resource: resource, onShow: handleShow, autoFocus: index === 0 })); }))));
};
