...
var Error = function (props) {
    ...
    return (React.createElement(react_1.Fragment, null,
        ...
        React.createElement("div", __assign({ className: (0, classnames_1.default)(classes.container, className) }, rest),
            ...
            process.env.NODE_ENV !== 'production' && (React.createElement(React.Fragment, null,
                React.createElement(core_1.Accordion, { className: classes.panel },
                    React.createElement(core_1.AccordionSummary, { expandIcon: React.createElement(ExpandMore_1.default, null) }, translate(error.toString(), {
                        _: error.toString(),
                    })),
                    errorInfo && (React.createElement(core_1.AccordionDetails, { className: classes.panelDetails }, errorInfo.componentStack))),
                React.createElement("div", { className: classes.advice },
                    React.createElement(core_1.Typography, { align: "center" }, "Need help with this error? Try the following:"),
                    React.createElement(core_1.Typography, { component: "div" },
            ...
            React.createElement("div", { className: classes.toolbar },
                React.createElement(core_1.Button, { variant: "contained", startIcon: React.createElement(History_1.default, null), onClick: goBack }, translate('ra.action.back'))))));
};
Error.propTypes = {
