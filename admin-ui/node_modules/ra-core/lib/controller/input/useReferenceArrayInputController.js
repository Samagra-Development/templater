...
var useReferenceArrayInputController = function (props) {
    ...
    var _f = (0, react_1.useState)(EmptyArray), idsToGetFromStore = _f[0], setIdsToGetFromStore = _f[1];
    ...
    var _m = (0, dataProvider_1.useGetMany)(reference, idsToFetch || EmptyArray), referenceRecordsFetched = _m.data, loaded = _m.loaded, refetchGetMany = _m.refetch;
    ...
    var isGetMatchingEnabled = enableGetChoices
        ...
        : true;
    var _o = (0, useGetMatching_1.default)(reference, pagination, sort, finalFilter, source, resource, options
